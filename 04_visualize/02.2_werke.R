        ...
        fluidRow(
            column(
                ...
                div(
                    ...
                    # Erste Zeile: Pie + Tabelle – jeweils in eigener Box
                    fluidRow(
                        column(
                            width = 6,
                            div(
                                ...
                                tagList(
                                    div(
                                        ...
                                        span("Verteilung der Aufträge", style = "font-weight: 600; font-size: 14px; color: #202124;"),
                        ...
                        column(
                            ...
                            div(
                                ...
                                tagList(
                                    div(
                                        style = "display: flex; align-items: center; gap: 6px; margin-bottom: 16px;",
                                        span("Ist- und Soll-Lead Time [Sek. pro ME]", style = "font-weight: 600; font-size: 14px; color: #202124;"),
                        ...
                        column(
                            ...
                            div(
                                ...
                                tagList(
                                    div(
                                        style = "display: flex; align-items: center; gap: 6px; margin-bottom: 16px;",
                                        span("Ist- und Sollmengen", style = "font-weight: 600; font-size: 14px; color: #202124;"),
