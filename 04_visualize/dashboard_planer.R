                            ...
                            div(
                                ...
                                div(
                                    ...
                                    span(
                                        ...
                                        tags$span(icon("circle-question"), id = "geschwindigkeit_me_info_planer", style = "color: #5f6368; font-size: 14px; cursor: pointer;")
                                    ),
                                    
                                    bsPopover(
                                        id = "geschwindigkeit_me_info_planer",
                            ...
                            div(
                                ...
                                div(
                                    ...
                                    span(
                                        ...
                                        tags$span(icon("circle-question"), id = "geschwindigkeit_auftrag_info_planer", style = "color: #5f6368; font-size: 14px; cursor: pointer;")
                                    ),
                                    
                                    bsPopover(
                                        id = "geschwindigkeit_auftrag_info_planer",
                                ...
                                div(
                                    ...
                                    tagList(
                                        div(
                                            ...
                                            tags$span(icon("circle-question"), id = "performance_table_info_planer", style = "color: #5f6368; font-size: 14px; cursor: pointer;")
                                        ),
                                        DTOutput("delay_table_shared_planer"),
                                        
                                        bsPopover(
                                            id = "performance_table_info_planer",
                                ...
                                div(
                                    ...
                                    tagList(
                                        div(
                                            ...
                                            tags$span(icon("circle-question"), id = "auftrverteilung_info_planer", style = "color: #5f6368; font-size: 14px; cursor: pointer;")
                                        ),
                                        
                                        bsPopover(
                                            id = "auftrverteilung_info_planer",
                                ...
                                div(
                                    ...
                                    tagList(
                                        div(
                                            ...
                                            tags$span(icon("circle-question"), id = "topdelay_info_planer", style = "color: #5f6368; font-size: 14px; cursor: pointer;")
                                        ),
                                        
                                        bsPopover(
                                            id = "topdelay_info_planer",
...
# KPIs der ausgewählten Ansicht
    ...
    output$donut_termintreue_planer <- renderEcharts4r({
        ...
        data_selected <- auftraege_lt_unit %>% filter(planer == sel)
        data_remaining <- auftraege_lt_unit %>% filter(planer != sel)
    ...
    output$donut_geschwindigkeit_me_planer <- renderEcharts4r({
        ...
        data_selected <- auftraege_lt_unit %>% filter(planer == input$selected_planer, !is.na(lt_ist_order))
    ...
    output$donut_geschwindigkeit_auftrag_planer <- renderEcharts4r({
        ...
        data_selected <- auftraege_lt_unit %>% filter(planer == input$selected_planer, !is.na(lead_time_ist))
...
# Zweidimensionale KPIs (Linie + ausgewählte Ansicht)
    ...
    output$delay_table_shared_planer <- renderDT({
        ...
        col_delay_table <- lt_map[[input$view_selection_planer]]
